...
4. **Rellenar el SKILL.md real** con lo que investigaste:
   - `name`: hyphen-case, minúsculas, sin espacios (ej. `stripe-webhooks`, no `Stripe Webhooks`).
